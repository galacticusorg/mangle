...
c-----------------------------------------------------------------------
     ...
     *  cmimin,cmimax,phi,iord,ldegen)
      ...
      logical ldegen
      real(kind=star10) area,areat,rp(3,np),cm(np),tol,cmimin,cmimax,phi(2,np)
c
c        parameters
      include 'pi.par'
...
c        sphere and region enclose each other
          elseif (cmimax.lt.0._star10) then
            area=areat-TWOPI*(2._star10-cm(npg))
          endif
...
c        inner ring of annulus and region enclose each other
            if (cmimax.ge.0._star10) then
              area=areat-TWOPI*(2._star10+cm(npp))
c        annulus and region enclose each other
            elseif (cmimax.lt.0._star10) then
              area=areat-TWOPI*(2._star10-cm(npg)-cm(npp))
            endif
          endif

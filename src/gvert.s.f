...
c-----------------------------------------------------------------------
     ...
     *  vcirc
      logical ldegen
      real(kind=star10) ve(3,nve,nvmax),angle(nvmax),rp(3,np),cm(np),tol
...
c        local (automatic) variables
     ...
     *  mve,ni,scmi
C     logical warn
      real(kind=star10) amve,cmi,dph,ikchk,ph,phm,php
      real(kind=star10) si,tolin,xi(3),xv,yi(3),yv,zv
c *
...
c        edge points
                ...
                enddo
                do ive=mve+1,nve
                  ve(1,ive,nv)=0._star10
                  ve(2,ive,nv)=0._star10
                  ve(3,ive,nv)=0._star10
                enddo
              endif
